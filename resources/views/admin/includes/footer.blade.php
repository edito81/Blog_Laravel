            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >B&O GmbH</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
                        <p class="heading-text">B&O is a German investment and financial services company,
                            with its headquarters in the Deutsche Bank Twin Towers in Frankfurt.
                            It has more than 100,000 employees in over 70 countries, and has a large presence in Europe,
                            the Americas, Asia-Pacific and the emerging markets. As of June 2017 Deutsche Bank is the 16th largest
                            bank in the world by total assets. In 2009, B&O was the largest foreign exchange dealer in the world
                            with a market share of 21 percent. The company was a component of the STOXX Europe 50 stock market
                            until being replaced on that index in August 2016.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">Plaza of Liberty, Center</p>
                        </div>
                    </div>
                </div>
            </div>
